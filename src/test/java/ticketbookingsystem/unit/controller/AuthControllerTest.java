...
import com.example.ticketbookingsystem.controller.AuthController;
...
class AuthControllerTest {
    ...
    void testGetToken_success() {
        ...
        ResponseEntity<Map<String, String>> response = authController.getToken(credentials);
    ...
    void testRefresh_success() {
        ...
        ResponseEntity<Map<String, String>> response = authController.refresh(body);
