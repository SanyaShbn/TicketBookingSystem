            ...
            <c:when test="${not empty requestScope.sport_events}">
                ...
                <div class="pagination">
                    <c:if test="${requestScope.page > 1}">
                        <a href="${pageContext.request.contextPath}/view_available_events?page=${param.page - 1}"
                    ...
                    <c:if test="${requestScope.sport_events.size() eq requestScope.limit}">
                        <a href="${pageContext.request.contextPath}/view_available_events?page=${param.page != null
