...
<header>
    ...
    <nav>
        <ul>
            <li><a href="<c:url value="..${pageContext.request.contextPath}/admin/arenas"/>"><fmt:message key="arenas.nav.link"/></a></li>
            <li><a href="<c:url value="..${pageContext.request.contextPath}/admin/sport_events"/>"><fmt:message key="events.nav.link"/></a></li>
        </ul>
    </nav>
